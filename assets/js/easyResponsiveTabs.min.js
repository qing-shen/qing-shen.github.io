...
var options=$.extend(defaults,options);var opt=options,jtype=opt.type,jfit=opt.fit,jwidth=opt.width,vtabs='vertical',accord='accordion';var tab_icons=new Array("fa fa-home icon_menu icon_menu_active","fa fa-info icon_menu","fa fa-tasks icon_menu","fa fa-users icon_menu","fa fa-book icon_menu","fa fa-tags icon_menu","fa fa-briefcase icon_menu","fa fa-envelope icon_menu");var i=1;this.each(function(){var $respTabs=$(this);$respTabs.find('ul.resp-tabs-list li').addClass('resp-tab-item');$respTabs.css({'display':'block','width':jwidth});$respTabs.find('.resp-tabs-container > div').addClass('resp-tab-content');jtab_options();function jtab_options(){if(jtype==vtabs){$respTabs.addClass('resp-vtabs');}
